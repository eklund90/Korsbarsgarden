...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="rfont" style="text-align: center; padding-bottom: 20px;">Kooperativet                
                </h1>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <h3 class="rfont">Personalkooperativ</h3>
                    <hr class="hr2" />
                ...
                <div class="col-md-5">
                    <img class="img-responsiv" src="images/_koperativ2.png" style="float: right" />
                    <%--Polaroid frame by lured2stock @ http://lured2stock.deviantart.com/art/Polaroid-3262470--%>
                </div>
            </div>
            <br />
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <img class="img-responsiv" src="images/_koperativ1.png" style="float: right" />
                    <%--Polaroid frame by lured2stock @ http://lured2stock.deviantart.com/art/Polaroid-3262470 --%>
                </div>
            </div>
        </div>
